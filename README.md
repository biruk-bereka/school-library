...
**School Library** is an app that can be used by parents, students and teachers.
...
```
git clone https://github.com/biruk-bereka/school-library.git
```
